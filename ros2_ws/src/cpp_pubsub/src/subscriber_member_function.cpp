...
public:
  ...
  {
    // the topic name and the type of messages have to be the same for the
...
private:
  ...
  {
    // RCLCPP_INFO is a ros MACRO that logs the message to the console
...
int main(int argc, char * argv[])
{
  ...
  // spin now calls the make_shared function for the <MinimalSubscriber> type
